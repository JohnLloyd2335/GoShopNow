                    ...
                    <div class="ms-auto text-end">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.profile.editaccountdetails') }}">Edit Profile</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="container py-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8">
                      <div class="card mb-4">
                        <div class="card-body">
                          <form action="{{ route('admin.profile.updateaccountdetails',auth()->user()->id) }}" method="POST">
                          @csrf
                          <div class="row">
                            <div class="col-sm-3">
